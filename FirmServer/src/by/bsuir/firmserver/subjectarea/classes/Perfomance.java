package by.bsuir.firmserver.subjectarea.classes;
...
public class Perfomance implements Serializable {
    ...
    public double getAssets(){
        return this.current_assets+this.fixed_assets+this.owned_assets;
    }
    
    public double getDuties(){
        return this.long_term_duties+this.short_term_duties+this.borrowed_capital;
    }
}
