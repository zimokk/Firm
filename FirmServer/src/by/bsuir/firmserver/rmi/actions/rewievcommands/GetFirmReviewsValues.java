...
public class GetFirmReviewsValues extends UnicastRemoteObject implements RemoteCustomCommand, Serializable   {

    DaoFactory daoFactory;
    
    public GetFirmReviewsValues(DaoFactory daoFactory) throws RemoteException {
        super();
    ...
    public <T> Object execute(T... args) throws RemoteException {
        ...
        try {
            ...
            Logger.getLogger(GetFirmReviewsValues.class.getName()).log(Level.SEVERE, null, ex);
        }
        return coefs;
    } 
}
